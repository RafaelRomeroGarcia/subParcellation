function [coorAnt,sortVertRegion]=sortVertexs(vertCoorx,vertexRegion,semilla,coorAnt)
sortVert=[];
...
difZ=maxZ-minZz;
    ...
    minx=vertCoorx(semilla,1);
    miny=vertCoorx(semilla,2);
    minz=vertCoorx(semilla,3);
end
for i=1:fin(2),
      vertex=vertexRegion(i);
      sortVert(i,1)=vertex;
